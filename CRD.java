...
public class CRD 
{
	...
	public CRD(String path)                        //Constructor for file path.It creates itself on C Drive 
	{
		...
		if(!f1.mkdir())                           
		{
			System.out.println("Can't Create DataStore");
		}
		else
		{
			System.out.println("DataStore Created at "+path);
		}
	}
	...
	public static void main(String[] args) throws IOException
	{
        ...
        System.out.println("Enter Path name as b to create Datastore : ");
        path = scan.next();
        if(path.equals("b")) path = def_path;
        ...
        while(opt!=4)
        {
            ...
            switch (opt) 
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.print("Enter the Filename to delete file: ");
                    key = scan.next();
                    ds.delete(path, key);
                    break;
                default:
